...
<div class="goods-add">
    ...
    <?php $form = ActiveForm::begin(); ?>
        ...
        <?= $form->field($model, 'goods_category_id')->dropDownList($options[0],['prompt'=>'请选择商品分类']) ?>
        <?= $form->field($model, 'brand_id')->dropDownList($options[1],['prompt'=>'请选择商品品牌']) ?>
    ...
    // ActiveForm
    echo $form->field($photo, 'imgFile')->widget('manks\FileInput', [
        'clientOptions' => [
            'pick' => [
                'multiple' => true,
            ],
